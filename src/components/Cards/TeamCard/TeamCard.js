    ...
    return (
        <Box>
            <Box display="flex" justifyContent="space-between" flexDirection={{base: "column", lg: "row"}}>
                ...
                <Box width={{base: "100%", lg:"25%"}} minHeight="150px" background="neutral.900" height="auto"  display="flex" justifyContent="space-between" padding={{base: "20px", lg:"15px 0"}} flexDirection={{base: "row", lg: "column"}} alignContent="center" flexWrap="wrap" alignItems="center">
