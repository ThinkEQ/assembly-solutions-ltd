...
const CardArticle = ({ title, date, imgSrc = false, imgAlt, imgFluid = false, slug = '#' }) => {
    ...
    return (
        <Box onClick={nav} cursor="grab" _active={{cursor: "grabbing"}} borderRadius="4px" display="flex" flexDirection="column" background="#fff" height={{base: "370px", md:"470px"}} width="100%" overflow="hidden">
