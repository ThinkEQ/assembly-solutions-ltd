...
MarketArticleTemplate.propTypes = {
...
export const pageQuery = graphql`
  query MarketArticleByID($id: String!) {
    markdownRemark(id: { eq: $id }, frontmatter: {templateKey: {eq: "market-article"}}) {
      id
      html
      frontmatter {
